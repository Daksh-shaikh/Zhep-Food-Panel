						...
						<div class="card">
                         ...
                         {{ session('success') }}
                            ...
                            @endif
								...
								<h6>Add Company Coupon</h6>
								<hr>
								<form class="row g-2" method="post" action="{{route('companyCouponStore')}}"  enctype="multipart/form-data">
                                    @csrf
									<div class="col-lg-2">
									...
									<tbody>
                                              ...
                                              <td style="background-color: #ffffff;">
                                                <div class="d-flex align-items-center">
                                                           ...
                                                           <?php if ($coupon->status=='1'){?>
                                                            ...
                                                            <a href="{{url('/update_company_coupon_status', $coupon->id)}}"
                                        ...
                                        {{--active inactive button end  --}}
											...
											<td style="background-color: #ffffff;">
                                                ...
                                                <a href="{{route('companyCouponEdit', $coupon->id)}}">
