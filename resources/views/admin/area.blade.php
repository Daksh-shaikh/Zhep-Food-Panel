                ...
                @endif
						...
						<div class="card">
							<div class="card-body">
								...
								<h6>Add Area</h6>
								<hr>
								<form class="row g-2" action="{{route('area-store')}}" method="post" >
                                    @csrf
                                    <div class="col-md-3"></div>
									<div class="col-lg-4">
										<label class="form-label">Area Name </label>
										<input type="text" class="form-control" id="exampleInputEmail1"
											aria-describedby="emailHelp" placeholder="" name="area">
						...
						<div class="card-body">
							<div class="table-responsive">
								<table id="example" class="table table-striped table-bordered">
                                    ...
                                    @if ($authenticatedUser->area)

                                    @foreach ($authenticatedUser->area->sortByDesc('created_at') as $data)
										<tr>
											<td>{{$loop->index+1}}</td>
                                        ...
                                        <td style="background-color: #ffffff;">
                                            <div class="d-flex align-items-center">
                                                    ...
                                                    <?php if ($data->status=='1'){?>
                                                        ...
                                                        <a href="{{url('/update-area-status', $data->id)}}"
